---
title: "SABR(Stochastic Alpha, Beta, Rho)모델 1"   # 글 제목 (bat가 자동 입력 — 한글로 고쳐 쓰면 됨)
date: 2026-08-04T22:28:56+09:00   # 작성일 — 목록 정렬 기준 (자동 입력)
...
# 2. CEV(Constant Elasticity of Variance) 모델
...
# 4. 2차원 확률미분방정식의 generator





# 5. 콜모고로프 후향 방정식과 특이 섭동론 (Singular Perturbation Theory)
